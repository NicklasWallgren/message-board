...
import dev.nicklasw.messageboard.adapter.driver.api.exception.ClientException;
import dev.nicklasw.messageboard.adapter.driver.api.response.ApiError;
import dev.nicklasw.messageboard.adapter.driver.api.response.BadRequestApiError;
import dev.nicklasw.messageboard.adapter.driver.api.response.FieldDescriptiveError;
