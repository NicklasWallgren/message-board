...
public class NotFoundClientException extends ClientException {
    ...
    private NotFoundClientException(final String missingObjectName, final List<Pair<String, Object>> byCriteria) {
     ...
     * @return todo
     */
    public static NotFoundClientException of(@NonNull final String missingObjectName, @NonNull final String criteriaKey1,
                                             @NonNull final Object criteriaValue1) {
        return new NotFoundClientException(missingObjectName,
